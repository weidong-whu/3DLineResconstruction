...
{
	float diff[3] = { rayPoint[0] - planePoint[0],
					  rayPoint[1] - planePoint[1],
					  rayPoint[2] - planePoint[2] };
...
{
	return std::abs(pt[0] * plane[0] + pt[1] * plane[1] + pt[2] * plane[2] + plane[3]) / std::sqrtf(plane[0] * plane[0] + plane[1] * plane[1] + plane[2] * plane[2]);
}
