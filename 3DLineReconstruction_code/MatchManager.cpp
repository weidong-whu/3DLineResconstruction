...
void MatchManager::writePairs(std::string addr)
{
	write2txt((float*)pairIndex.data, pairIndex.rows, pairIndex.cols, addr);
}
...
{
	return (ushort*)matcheArr[pairID].data
		+ matchID * matcheArr[pairID].cols;
}
